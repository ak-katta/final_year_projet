...
<header>
  ...
  <div class="run">Run <b>{e(d['run_id'])}</b><br>{e(d['generated_at'])}</div>
</header>
<main>
  <section class="hero">
...
<header>
  ...
  <div class="run">Run <b>{e(d['run_id'])}</b><br>{e(d['generated_at'])}<br><a href="dashboard.html">&larr; dashboard</a></div>
</header>
<main>
  <section class="panel">
    <h2>Tests</h2>
